...
int main(void)
{
     cout << endl
          ...
          << endl
          << endl;
     List<Etudiant> *listeEtudiants = new List<Etudiant>(); // creer une liste vide
     // seed pour random
     srand((unsigned)time(NULL));
     // cas de la liste vide
     listeEtudiants->afficher();
     ...
     for (int i = 0; i < size; i++)
     {
         ...
         // Point *p = new Point(rand() % 100, rand() % 100); // creer un point dynamique avec coordonnees aleatoires
          Etudiant *p=new Etudiant(i+1,"test"); 
          listeEtudiants->ajouterFin(*p);                            // ajouter le point a la fin de la liste
    ...
    // cout << "La liste contient " << liste->getQuantiteNodes() << " points:" << endl;
     listeEtudiants->afficher(); // afficher les points de la liste
     ...
     // liste->afficher(); // afficher les points de la liste
     //delete listeEtudiants;      // liberation de la memoire occupee par la liste
     cout << endl
          << endl
